...
export const StyledWrap: ComponentType<any> = styled(Box)(() => ({
  gap: 8,
  display: 'grid',
...
export const StyledCard: ComponentType<any> = styled(CardActionArea, {
...
export const StyledCircleColor: ComponentType<any> = styled('div', {
  shouldForwardProp: (prop) => prop !== 'selected',
