...
// config
import { ICON, NAV } from '@/app-config';
//
...
export const StyledItem: ComponentType<any> = styled(ListItemButton, {
...
export const StyledDotIcon: ComponentType<any> = styled('span', {
...
export const StyledSubheader: ComponentType<any> = styled(ListSubheader)(({ theme }) => ({
